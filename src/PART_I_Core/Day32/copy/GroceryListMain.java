...
public class GroceryListMain {
	...
	public static void modifyItem() {
		...
		scanner.nextLine();// yukarıda int olduğu için aşağıdaki string satırımı atlıyor malum.
		
		System.out.println("Enter replacacement item: ");
		String newItem=scanner.nextLine();
		groceryList.modifyGroceryItem(itemNo-1,newItem);// itemNo sıfırdan başladığı için
	}
