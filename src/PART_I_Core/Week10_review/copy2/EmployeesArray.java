...
public class EmployeesArray {
	...
	public static void main(String[] args) {
		...
		// print all job titles in the consol
		...
		// print names and job titles together
		for(String names: employees) {
			
			String job=names.substring(0, names.indexOf("]"));
			System.out.println(job);
		}
		System.out.println("================");
		// "Tracy Bartle" should be geogragical Engineer
		// if true --> print_> verification succesfull
		// else  print-> verification error
		
		for (String title: employees) {
			String[] person= title.split(" ");
			String name=person[0];
			String last=person[1];
			String job=person[1];
			if (name.equals("Tracy") && last.equals("Bartle")) {
