...
public class Q_78_reverseVowels {

	public static void main(String[] args) {
		
		String word="aeioueherinde";
	...
	public static String reverseVowels(String word) {
		...
		int count2=0; // count the element which is done from the right
			do {
				for(int i=count1;i<word.length()-1-count2;i++) { // look for vowel from left
				...
				for(int j=word.length()-1-count2;j>index1;j--) {     //look for vowel from right
